<x-app-layout>
    <x-slot name="header">
        <div>
            <div class="kicker">
                <i class="fa-solid fa-house-circle-plus"></i> INPUT DATA CEPAT
            </div>
            <h1>Tambah Data Rumah RTLH</h1>
            <p class="muted">
                Daftarkan data awal rumah tidak layak huni baru ke dalam basis data Kabupaten Cirebon.
            </p>
        </div>
        ...
        <form method="POST" action="{{ route('houses.store') }}">
                ...
                <div class="form-group">
                    ...
                    <select id="region_id" name="region_id" required>
                        ...
                        @foreach ($villages as $village)
                            <option value="{{ $village->id }}" @selected(old('region_id') == $village->id)>
                                {{ $village->name }}
                            </option>
                        @endforeach
                    </select>
            ...
            <div class="card" style="margin-bottom:20px;">
                ...
                <div class="form-group">
                    ...
                    <textarea
                        ...
                        name="address"
                        rows="2"
                        placeholder="Contoh: Jl. Pangeran Sutajaya No. 12"
            ...
            <div class="actions" style="justify-content: flex-end;">
                ...
                <button type="submit" class="btn primary">
                    <i class="fa-solid fa-floppy-disk"></i> Simpan Data Rumah
                </button>
            </div>
        </form>
    </div>
